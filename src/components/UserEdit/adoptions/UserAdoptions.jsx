...
function UserAdoptions() {
    ...
    if (status === "loading") {
        return (
            <>
                ...
                <div className={`bg-transparent ${toggleState ? "lg:ml-64" : "lg:ml-24"} transition-all duration-300 mt-20 !z-10 min-h-screen flex justify-center items-center`}>
                    <div role="status">
    ...
    return (
        <>
            <UserNavbar showModal={!showNavbar} />
            <div className={`bg-transparent ${toggleState ? "lg:ml-64" : "lg:ml-24"} transition-all duration-300 mt-20 !z-10 flex justify-center rounded-2xl relative flex-col items-center`}>
                ...
                {adoptions && adoptions.length === 0 ? (
                    ...
                    <>
                        <div className="relative w-full overflow-hidden min-h-[1000px] sm:min-h-[950px] lg:min-h-[600px]" >
                            {adoptions &&
