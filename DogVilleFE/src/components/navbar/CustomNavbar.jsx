...
function CustomNavbar() {
    ...
    return (
        <nav
            className={`${toggleState ? "!ml-64" : "!ml-24"} transition-all duration-300 fixed top-0 left-0 w-full z-50 mt-10 sm:mt-0 h-36`}
            id="navbara"
        >
            {toggleState && (
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between px-4 sm:px-6 lg:px-8 mx-3">
                    ...
                    {/* Links */}
                    <div className="hidden w-full sm:block sm:w-auto overflow-x-auto mr-28 invisible">
